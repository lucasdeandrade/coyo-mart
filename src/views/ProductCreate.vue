      ...
      <div class="card-body p-3 pt-0">
        ...
        <div class="text-start col-3 mb-4">
          ...
          <input
            type="text"
            class="form-control"
            v-model="this.product.unit_type"
            required
          />
        </div>
        <div class="text-start col-3 mb-4">
        ...
        <div class="text-start col-3 mb-4">
          <label class="fw-bold">Image do Produto</label>
          <input-img-products/>
        </div>
...
import inputImgProducts from "../components/InputImageProducts.vue"
