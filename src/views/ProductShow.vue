      ...
      <div class="modal-content p-4 dialog ">
        ...
        <div class="modal-body pt-2">
          ...
          <div class="row justify-content-center">
            <button type="button" class="col-3 m-3 mr-3 btn btn-primary" @click="deleteProduct">Sim</button>
  ...
  <div class="col-10 shadow main"> 
      <div class="row justify-content-between pt-3 px-3">
        ...
        <div class="col-3 d-flex justify-content-around">
          <button class="col-5 btn btn-outline-primary btn-sm rounded" @click="goToEdit(product.id)">Editar</button>
